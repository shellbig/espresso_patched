...
#ifndef SCRIPT_INTERFACE_CONSTRAINTS_ALTERNATINGMAGNETICFIELD_HPP
#define SCRIPT_INTERFACE_CONSTRAINTS_ALTERNATINGMAGNETICFIELD_HPP

#include "core/constraints/Constraint.hpp"
#include "core/constraints/AlternatingMagneticField.hpp"
...
public:
  AlternatingMagneticField()
      : m_constraint(
            std::make_shared<::Constraints::AlternatingMagneticField>()) {
    add_parameters({{"H0",
  ...
  std::shared_ptr<::Constraints::AlternatingMagneticField>
...
private:
  ...
  std::shared_ptr<::Constraints::AlternatingMagneticField> m_constraint;
};
